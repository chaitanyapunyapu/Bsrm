...
const routes: Routes = [
  ...
  {path:'motor',component:MenuComponent},
  {path:'bajaj/:id',component:MotorpageComponent},
  {path:'honda/:id',component:HondapageComponent},
  {path:'yamaha/:id',component:YamahapageComponent},
  {path:'ktm/:id',component:KtmpageComponent},
  {path:'suzuki/:id',component:SuzukipageComponent},
  {path:'hero/:id',component:HeropageComponent},
  {path:'tvs/:id',component:TvspageComponent},
  {path:'re/:id',component:RepageComponent},
